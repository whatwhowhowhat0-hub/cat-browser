...
from PyQt5.QtWidgets import (
    ...
    QGraphicsDropShadowEffect, QWidgetAction, QSizePolicy, QAction
)
from PyQt5.QtMultimedia import QMediaPlayer
from PyQt5.QtMultimediaWidgets import QVideoWidget
from PyQt5.QtWebEngineWidgets import (
    QWebEngineView, QWebEnginePage, QWebEngineProfile, 
    QWebEngineSettings, QWebEngineScript, QWebEngineDownloadItem
)
from PyQt5.QtGui import (
    QPixmap, QPainter, QPen, QIcon, QFontDatabase, QFont,
...
WELCOME_IMG = resource_path("welcome.png")
FONT_FILE = resource_path("vrc.ttf")
BG_IMG = resource_path("bg.png")
BG2_IMG = resource_path("bg2.png")
FACTS_FILE = resource_path("facts.txt")
LANGUAGES_FILE = resource_path("languages.txt")
...
class CustomNewTabPage(QWidget):
    def __init__(self, parent=None, translator=None, theme_engine=None):
        ...
        self.bg_container.setSizePolicy(QSizePolicy.Expanding, QSizePolicy.Expanding)
        ...
        self.search_bar.setStyleSheet("""
            ...
            margin-bottom: 40px;
        """)
        overlay_layout.addWidget(self.search_bar, 0, Qt.AlignCenter)
        ...
        self.shortcuts_layout.setAlignment(Qt.AlignCenter)
    ...
    def show_credits(self):
        ...
        <p>PyQt5 Team  - {self.translator.tr('for_webengine', 'For the WebEngine')}</p>
        </div>
        """)
...
class SetupWizard(QDialog):
    ...
    def create_steps(self):
        ...
        self.title4.setAlignment(Qt.AlignCenter)
        ...
        self.title5.setAlignment(Qt.AlignCenter)
        ...
        self.desc5.setAlignment(Qt.AlignCenter)
        ...
        """)
        self.credits_btn.clicked.connect(self.show_credits)
        step5_layout.addWidget(self.credits_btn, alignment=Qt.AlignCenter)
...
class WelcomeScreen(QWidget):
    ...
    def __init__(self, duration=2000, text=""):
        super().__init__()
        self.setWindowFlags(Qt.FramelessWindowHint | Qt.WindowStaysOnTopHint)
        self.setStyleSheet("background-color: rgb(26,26,38);")
        ...
        text_label.setStyleSheet(f"color:white;font-size:24px;font-family:'{font_family}';")
...
class SettingsTab(QWidget):
    ...
    def on_welcome_setting_changed(self, state):
        self.browser.settings["show_welcome_screen"] = (state == Qt.Checked)
        self.browser.save_settings()
    ...
    def on_memory_saver_changed(self, state):
        self.browser.settings["memory_saver"] = (state == Qt.Checked)
        self.browser.save_settings()
        self.browser.enable_memory_saver(state == Qt.Checked)
...
if __name__ == "__main__":
    ...
    if not os.path.exists(SETUP_FILE):
        splash = WelcomeScreen(2000, "Setting up Cat Browser...")
        splash.show()
